...
// result
console.log(objectToQueryString(undefined)); //
console.log(objectToQueryString({ page: 1 })); // ?page=1
console.log(objectToQueryString({ page: 1, searchType: 'Title' })); // ?page=1&searchType=Title
console.log(
  objectToQueryString({
    page: 1,
    searchType: 'Title',
